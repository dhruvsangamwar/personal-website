  ...
  return (
    <section>
      ...
      <p className="mb-4">
        ...
        <Link href="https://dhruvsangamwar.notion.site/ECS-198F-Diving-deep-into-the-world-of-Algorithms-Competitive-programming-and-more-4faece565e2e4c25a517970354a66102" className='underline'>
          {`teach`} 
        </Link>        
      ...
      <p className="mb-4">
        When I’m not at my computer, you can find me hiking, traveling, or bouldering.
      </p>
    </section>
  );
}
